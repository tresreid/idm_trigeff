...
if options.test:
    ...
    if 'cmslpc' in platform.node():
        if options.year == 2017:
            options.inputFiles = 'root://cmseos.fnal.gov//store/user/mreid/iDM/AOD_Samples/Mchi-60_dMchi-20/lifetime_1000mm/iDM_Mchi-60_dMchi-20_mZD-150_Wchi2-1p00e-03_slc6_amd64_gcc481_CMSSW_7_1_30_tarball_8256548_ctau-1000_AOD.root'
