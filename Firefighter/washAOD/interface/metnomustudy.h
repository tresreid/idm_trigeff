#ifndef washAOD_metnomustudy_H
#define washAOD_metnomustudy_H
...
{
  public:
    explicit metnomustudy(const edm::ParameterSet&);
    ~metnomustudy();
  ...
  private:
    ...
    const edm::InputTag pfmuTrackTag_;
    ...
    const edm::EDGetTokenT<std::vector<reco::Muon>> pfmuTrackToken_;
    ...
    edm::Handle<std::vector<reco::Muon>> pfmuTrackHandle_;
