...
for mass in masslist:
	for life in lifelist:
		cmdx = "cmsRun python/tuplizer_cfg.py year=2017 inputFiles_load=data/iDM/{0}_{1}mm.txt outputFile=~/nobackup/trigeff_output_withMuAndGenInfo/output_{0}_{1}mm.root".format(mass,life)
		print cmdx
